...
<?= $this->section('title') ?>
<title>New Cart | Teanology</title>
<?= $this->endSection(); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Add Cart</h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <div id="products-datatable_wrapper" class="dataTables_wrapper dt-bootstrap">
                                ...
                                <div class="row">
                                    <div class="table-responsive">
                                        <form action="<?= site_url('cart') ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                                            <?= csrf_field() ?>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="example-number" type="number" name="quantity_cart" required>
                                            </div>
