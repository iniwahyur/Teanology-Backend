...
<?= $this->section('title') ?>
<title>Update Cart | Teanology</title>
<?= $this->endSection(); ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                <a href="<?= site_url('cart') ?>" class="btn btn-success mb-2 me-1">
                        ...
                        <div class="table-responsive">
                            <div id="products-datatable_wrapper" class="dataTables_wrapper dt-bootstrap">
                                ...
                                <div class="row">
                                    <div class="table-responsive">
                                        <form action="<?= site_url('cart/update/' . $cart->id_cart) ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                                            <?= csrf_field() ?>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="example-number" type="number" name="quantity_cart" value="<?=$cart->quantity_cart?>" required>
                                            </div>
