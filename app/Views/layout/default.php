...
<body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
    ...
    <div class="wrapper">
        ...
        <div class="leftside-menu">
            ...
            <!-- LOGO -->
            <a href="<?= site_url('dashboard') ?>" class="logo text-center logo-light">
                <span class="logo-lg">
                    <img src="<?= base_url() ?>/assets_image/teanology_4.png" alt="" height="28">
                </span>
                <!-- <span class="logo-sm">
            ...
            <!-- LOGO -->
            <a href="<?= site_url('dashboard') ?>" class="logo text-center logo-dark">
                <span class="logo-lg">
                    <img src="<?= base_url() ?>/template/assets/images/logo-dark.png" alt="" height="16">
                </span>
                <span class="logo-sm">
                    <img src="<?= base_url() ?>/template/assets/images/logo_sm_dark.png" alt="" height="16">
                </span>
            </a>
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <span class="account-user-avatar">
                                    <?php if (adminLogin()->photo_admin) : ?>
                                        <img src="<?= base_url('uploads/' . adminLogin()->photo_admin) ?>" alt="<?= adminLogin()->name_admin ?>" class="rounded-circle">
                                    <?php endif; ?>
                                </span>
                                <span>
                                    <span class="account-user-name"><?= adminLogin()->name_admin ?></span>
                                    <span class="account-position">
                                        <?php
                                        $status = adminLogin()->role_admin;
                                        $status_text = '';
                                        ...
                                        switch ($status) {
                                            case 'super_admin':
                                                ...
                                                break;
                                            case 'admin':
                                            case 'Super Admin': // Tambahkan case baru untuk menangani 'Super Admin' yang ditulis dengan huruf kapital
                                                $status_text = 'Admin';
                                                break;
                                            default:
