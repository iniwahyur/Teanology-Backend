...
<?= $this->section('title') ?>
<title>Data Wishlist | Teanology</title>
<?= $this->endSection(); ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                <a href="<?= site_url('wishlist/new') ?>" class="btn btn-success mb-2 me-1">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="table-action">
                                                            <a href="<?= site_url('wishlist/edit/' . $value->id_wishlist) ?>" class="action-icon"> <i class="mdi mdi-pencil btn btn-warning mb-2 text-white"></i></a>
                                                            <form action="<?= site_url('wishlist/delete/' . $value->id_wishlist) ?>" method="post" class="d-inline" onsubmit="return confirm('Yakin hapus data?')">
                                                                <?= csrf_field() ?>
